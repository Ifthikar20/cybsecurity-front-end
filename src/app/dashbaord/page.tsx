...
export default function Dashboard() {
  ...
  // Format evaluation text into bullet points
  const formatEvaluation = (evaluationText: string) => {
    ...
    if (evaluationPoints.length > 1) {
      ...
      return <p className="whitespace-pre-wrap">{evaluationText}</p>;
    }
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700 mb-8">
          ...
          <div className="space-y-6">
            {/* Display reasoning steps with filtering */}
            {(() => {
              ...
              if (expandedReasonings.has('filter-by-vuln')) {
                // Filter by vulnerability ID if active
                ...
                // Show just the first few steps if not showing all and not filtering
                          ...
                          {expandedReasonings.has(`${step.id}-eval`) ? (
                            <>
                              <div className="text-gray-300 text-sm bg-gray-800 p-4 rounded border border-gray-700 mb-2">
                                ...
                                {formatEvaluation(step.evaluation)}
                              </div>
                              <button 
                                onClick={() => {
                                  setExpandedReasonings(prev => {
                            ...
                            {relatedReasoning.evaluation && (
                              <div className="mt-4">
                                ...
                                <div className="text-gray-300 text-sm bg-gray-800 p-4 rounded border border-gray-700">
                                  {formatEvaluation(relatedReasoning.evaluation)}
                                </div>
                              </div>
                            )}
